...
class App extends Component {							// Step 4: Write a class called App, extending Component.
	constructor() { 												// Step 5: Write a constructor function without passing anything into it.
		...
		this.state = { 												// Step 7: Inside the constructor function, create a state on this, and set it to an object.
			movies: [ 													// Step 8: Inside the object, set a key to movies, and the value to an array of movies.
			  'Dusk to Dawn',
			  'Blade Runner',
			  'Super Bad',
			  'Enemy of the State',
	...
	render() { 															// Step 9: Write a render function.
		return (															// Step 10: Inside the render function, write a return statement.
		  MoviesList(													// Step 11: Inside the return statement, write a selfclosing tag called MoviesList
		    { movies: this.state.movies }			// Step 12: Inside the selfclosing tag, give it an attribute called movies, and pass it this.state.movies inside a set of curly bracket.
		  )				
		);
	}
}
